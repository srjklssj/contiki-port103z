...
#define  Enc_Select()	(GPIOA->ODR &= ~(1<<4))
#define  Enc_NoSelect()	(GPIOA->ODR |= 1<<4)
#define ENC_INT_PIN() (GPIOA->IDR & 0x08)

//#define   ENC28J60_RSTL()   //(GPIOB->ODR &= ~(1<<1))
//#define   ENC28J60_RSTH()   //(GPIOB->ODR |= 1<<1)
